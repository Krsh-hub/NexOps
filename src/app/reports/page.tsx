  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-[1400px]">
      <div>
        ...
        <p className="text-[15px] text-[var(--text-tertiary)] mt-1">Auto-generated operational reports</p>
      </div>
        ...
        {reports.map((r) => (
          <div key={r.name} className="card-elevated p-5 flex items-start gap-4 group">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-[16px] font-semibold text-[var(--text-primary)]">{r.name}</h3>
              <p className="text-[16px] text-[var(--text-tertiary)] mt-1">{r.desc}</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="text-[16px] uppercase tracking-wider font-semibold text-[var(--text-quaternary)] bg-[var(--bg-hover)] px-1.5 py-0.5 rounded-md">{r.type}</span>
                <span className="text-[16px] text-[var(--text-quaternary)]">{r.freq}</span>
              </div>
            </div>
